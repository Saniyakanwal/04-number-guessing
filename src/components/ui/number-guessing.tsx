...
import { Input } from "../ui/input";
    ...
    interface NumberGuessingState {
      ...
      export default function NumberGuessingState(){
...
useEffect(() => {
  ...
  const handleUserGuessChange = (e: ChangeEvent<HTMLInputElement>): void => {
    ...
    return(
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-blue-600 to-black">
        <div className="bg-gradient-to-bl rounded-lg shadow-lg p-8 w-full max-w-md">
